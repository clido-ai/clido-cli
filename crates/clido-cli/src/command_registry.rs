...
pub static COMMANDS: &[SlashCommand] = &[
    ...
    SlashCommand {
        name: "/prompt-mode",
        section: "Settings",
        description: "show or set prompt enhancement mode",
        usage: Some("/prompt-mode [auto|off|status]"),
        takes_args: true,
        requires_idle: false,
    },
    SlashCommand {
        name: "/prompt-preview",
        section: "Settings",
        description: "preview the enhanced version of your next message before sending",
        usage: None,
        takes_args: false,
        requires_idle: false,
    },
    SlashCommand {
        name: "/prompt-rules",
        section: "Settings",
        description: "manage prompt enhancement rules",
        usage: Some("/prompt-rules [list|add <text>|remove <id>|reset]"),
        takes_args: true,
        requires_idle: false,
    },
    // ── Git ──────────────────────────────────────────────────────
    ...
    SlashCommand {
        name: "/role",
        section: "Model",
        description: "pick a role or switch",
        usage: Some("/role [name]"),
        takes_args: true,
        requires_idle: false,
    },
    SlashCommand {
        ...
        usage: Some("/role add <name> <model_id>"),
        takes_args: true,
        requires_idle: false,
    },
    SlashCommand {
    ...
    SlashCommand {
        name: "/agents",
        section: "Project",
        description: "show current agent configuration (main, worker, reviewer)",
        usage: None,
        takes_args: false,
        requires_idle: false,
    },
