...
pub static COMMANDS: &[SlashCommand] = &[
    ...
    SlashCommand {
        name: "/skill",
        section: "Skills",
        description: "skill management — create, show, edit, save",
        usage: Some("/skill [new|show|edit|save]"),
        takes_args: true,
        requires_idle: false,
    },
    SlashCommand {
    ...
    SlashCommand {
        name: "/skill show",
        section: "Skills",
        description: "display a skill's content in the chat",
        usage: Some("/skill show <id>"),
        takes_args: true,
        requires_idle: false,
    },
    SlashCommand {
        name: "/skill edit",
        section: "Skills",
        description: "edit a skill with AI assistance",
        usage: Some("/skill edit <id> <description of changes>"),
        takes_args: true,
        requires_idle: false,
    },
    SlashCommand {
        name: "/skill save",
        section: "Skills",
        description: "save the last skill markdown from chat to .clido/skills/",
        usage: Some("/skill save <id>"),
        takes_args: true,
        requires_idle: false,
    },
