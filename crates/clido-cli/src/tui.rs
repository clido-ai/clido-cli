...
fn cmd_model(app: &mut App, cmd: &str) {
...
fn cmd_role(app: &mut App, cmd: &str) {
...
fn cmd_reviewer(app: &mut App, cmd: &str) {
    if !app.reviewer_configured {
        app.push(ChatLine::Info(
...
fn cmd_workdir_arg(app: &mut App, cmd: &str) {
...
fn cmd_copy(app: &mut App, cmd: &str) {
...
fn cmd_search(app: &mut App, cmd: &str) {
...
fn cmd_memory(app: &mut App, cmd: &str) {
...
fn cmd_rollback(app: &mut App, cmd: &str) {
...
fn cmd_plan(app: &mut App, cmd: &str) {
...
fn cmd_branch(app: &mut App, cmd: &str) {
...
fn cmd_ship(app: &mut App, cmd: &str) {
...
fn cmd_save(app: &mut App, cmd: &str) {
...
fn cmd_notify(app: &mut App, cmd: &str) {
...
fn cmd_profile_edit(app: &mut App, cmd: &str) {
...
fn cmd_profile_switch(app: &mut App, cmd: &str) {
...
fn cmd_configure(app: &mut App, cmd: &str) {
...
fn cmd_prompt_mode(app: &mut App, cmd: &str) {
...
fn cmd_prompt_rules(app: &mut App, cmd: &str) {
