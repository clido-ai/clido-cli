        ...
        match msg {
            ...
            ChatLine::Info(text) => {
                if text.is_empty() {
                    ...
                    // Use reduced width to account for gutter prefix
                    let info_gutter_width = unicode_display_width(TUI_GUTTER) + 2; // "› "
                    let info_content_width = width.saturating_sub(info_gutter_width);
